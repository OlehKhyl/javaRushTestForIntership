...
public class Player {
    ...
    public Player(String name, String title, String race, String profession, Date birthday, Boolean banned, Integer experience, Integer level, Integer untilNextLevel) {
        this.name = name;
        this.title = title;
    ...
    public Player(String name, String title, Race race, Profession profession, Date birthday, Boolean banned, Integer experience) {
        ...
        this.untilNextLevel = calculateExperienceUntilNextLevel(level, experience);
    }
    ...
    public Integer calculateExperienceUntilNextLevel(Integer level, Integer experience) {
